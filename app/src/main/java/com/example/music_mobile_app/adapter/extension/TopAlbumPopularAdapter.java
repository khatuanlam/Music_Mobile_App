...
import com.example.music_mobile_app.ui.extension.album.AlbumDetailFragment;
...
public class TopAlbumPopularAdapter extends RecyclerView.Adapter<TopAlbumPopularAdapter.TopSongViewHolder> {
    ...
    private static List<Album> mDataList = new ArrayList<Album>();
    ...
    public TopSongViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.extension_item_top_popular, parent, false);
    ...
    public class TopSongViewHolder extends RecyclerView.ViewHolder {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        manager.beginTransaction().replace(R.id.fragment, albumDetailFragment).commit();
                    }
                }
            });
        ...
        public void bind(Album t) {
            ...
            if (t.getImage() != null && !t.getImage().isEmpty()) {
                Glide.with(fragment).load(t.getImage()).into(imageView);
            }
