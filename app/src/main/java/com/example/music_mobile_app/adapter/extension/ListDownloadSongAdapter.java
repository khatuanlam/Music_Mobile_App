...
public class ListDownloadSongAdapter extends RecyclerView.Adapter<ListDownloadSongAdapter.LiteSongViewHolder> implements OnPlaylistClickListener {
    ...
    public void onPlaylistClick(Playlist playlist) {
        ...
        alertDialog.dismiss();
        songsOfPlaylistViewModel.postSongToPlaylist(selectedSong.getId_Db(), playlist.getId());
    }
    ...
    public LiteSongViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mydb_list_item_downloadsong, parent, false);
    ...
    public class LiteSongViewHolder extends RecyclerView.ViewHolder {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        mediaPlayer.setDataSource(context, Uri.parse("file:///storage/emulated/0/Download/" + song.getId_Db() + ".mp3"));
                        mediaPlayer.prepare();
                        mediaPlayer.start();
                    } catch (IOException e) {
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    switch (menuItem.getItemId()) {
                        case R.id.mydb_menu_item_song_addToFavorite:
                            favoriteSongsViewModel.postFavoriteSongToUser(song.getId_Db(), userId);
                            break;
        ...
        public void bind(LiteSong song) {
            ...
            if (song.getImage() != null && !song.getImage().isEmpty()) {
                Glide.with(fragment).load(song.getImage()).into(imageView);
            }
