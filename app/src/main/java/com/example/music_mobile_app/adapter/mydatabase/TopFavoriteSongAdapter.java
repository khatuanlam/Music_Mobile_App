...
public class TopFavoriteSongAdapter extends RecyclerView.Adapter<TopFavoriteSongAdapter.TopSongViewHolder> {
    private Fragment fragment;
    private List<Song> mDataList;
    private Context context;

    public TopFavoriteSongAdapter(Context context, Fragment fragment, List<Song> dataList) {
