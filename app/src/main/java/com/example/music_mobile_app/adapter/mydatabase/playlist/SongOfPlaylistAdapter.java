...
public class SongOfPlaylistAdapter extends RecyclerView.Adapter<SongOfPlaylistAdapter.SongViewHolder> {
    ...
    public SongOfPlaylistAdapter(Context context, Fragment fragment , List<Song> dataList, Playlist playlist, SongsOfPlaylistViewModel songsOfPlaylistViewModel) {
    ...
    public class SongViewHolder extends RecyclerView.ViewHolder {
        ...
        private void showPopupMenu(View view) {
            ...
            popupMenu.inflate(R.menu.mydb_list_item_song_playlist); // Assuming you have defined a menu resource file named song_menu.xml
                ...
                public boolean onMenuItemClick(MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()) {
                        ...
                        case R.id.mydb_menu_item_song_favorite_download:
                            Toast.makeText(context, song.getName() +"download", Toast.LENGTH_SHORT).show();
                            break;
                    }
                    return true;
                }
